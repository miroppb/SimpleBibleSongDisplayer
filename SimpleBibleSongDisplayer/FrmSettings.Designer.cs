namespace SimpleBibleSongDisplayer
{
    partial class FrmSettings
    {
        ...
        private void InitializeComponent()
        {
			...
			this.ChkFullSong = new System.Windows.Forms.CheckBox();
			...
			// ChkFullSong
			// 
			this.ChkFullSong.AutoSize = true;
			this.ChkFullSong.Location = new System.Drawing.Point(125, 248);
			this.ChkFullSong.Name = "ChkFullSong";
			this.ChkFullSong.Size = new System.Drawing.Size(70, 17);
			this.ChkFullSong.TabIndex = 9;
			this.ChkFullSong.Text = "Full Song";
			this.ChkFullSong.UseVisualStyleBackColor = true;
			// 
			// FrmSettings
			// 
			...
			this.Controls.Add(this.ChkFullSong);
		...
		public System.Windows.Forms.CheckBox ChkFullSong;
	}
}